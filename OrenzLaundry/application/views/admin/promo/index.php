<div class="container-fluid">
  ...
  <div class="block-header">
      <div class="row">
          <div class="col-12">
              ...
              <ul class="breadcrumb bg-transparent ml-n3 mt-n3">
  ...
  <button class="btn btn-sm btn-ijo mb-3" data-toggle="modal" data-target="#tambah_barang"><i class="fas fa-plus fa-sm mr-2"></i>Tambah Barang</button>

  <?php echo $this->session->flashdata('pesan');?>
  <table id="DataTable" class="table table-bordered table table-white">
