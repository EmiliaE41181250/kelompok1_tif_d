        ...
        <?php foreach ($promo as $prm) { ?>
          ...
          <form action="<?=  base_url() . 'admin/promo/update'?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input value="<?=$prm->judul_promo?>" type="text" name="judul_promo" id="judul_promo" class="form-control" placeholder="Masukkan Judul Pomo . ." aria-describedby="JudulPromo" maxlength="100" required>
              <small id="JudulPromo" class="text-muted">Masukkan Judul Promo tidak lebih dari 100 Karakter</small>
            </div>
            <div class="form-group">
              <label for="deskripsi">Deskripsi</label>
              <textarea type="text" name="deskripsi" id="deskripsi" class="form-control" aria-describedby="descPromo" required><?=$prm->deskripsi?></textarea>
