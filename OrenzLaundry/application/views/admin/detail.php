  ...
  <div class="row justify-content-center py-3">
    <div class="col-md-8 card p-0">
      <div class="card-header pb-0">
        <h2 class="font-weight-bolder mb-0">Detail Durasi Paket</h2>
        <ul class="breadcrumb bg-transparent ml-n3 mt-n3 mb-0">
            <li class="breadcrumb-item"><a href="<?=base_url()?>admin/dashboard"><i class="fa fa-home"></i> OrenzLaundry</a></li>
            <li class="breadcrumb-item"><a href="<?=base_url()?>admin/C_isipaket"></i> Durasi Paket</a></li>
            <li class="breadcrumb-item active">Detail Durasi Paket</li>
        </ul>
      </div>
      <div class="card-body">
        ...
        <?php foreach ($durasi_paket as $ip) { ?>
          ...
          <table class="table table-borderless">
            <thead>
              <tr>
                <th>ID Durasi Paket</th>
                <th>:</th>
                <th><?=$ip->id_durasi_paket?></th>
              </tr>
            </thead>
            <tbody>
              <tr>
