    ...
    <?php if (isset($data_harian)) { ?>
        ...
        <div class="row card mt-3 mb-4 mx-1">
            <div class="col card-body table-responsive">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="<?= base_url() . 'admin/laporan_rentang_hari/print_pdf_rentang/' . $awal .'/'. $akhir ?>" class="btn btn-sm btn-warning mb-2"><i class="fas fa-file-pdf fa-sm mr-2"></i>Cetak Pdf</a>
                    </div>
                </div>
                <div class="row">
